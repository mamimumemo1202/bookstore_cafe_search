...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<actionpack>.freeze, [">= 7.2"])
    ...
    s.add_development_dependency(%q<aruba>.freeze, ["~> 2.3.1"])
    s.add_development_dependency(%q<cucumber>.freeze, [">= 10.0"])
  else
    s.add_dependency(%q<actionpack>.freeze, [">= 7.2"])
    s.add_dependency(%q<activesupport>.freeze, [">= 7.2"])
    s.add_dependency(%q<railties>.freeze, [">= 7.2"])
    ...
    s.add_dependency(%q<aruba>.freeze, ["~> 2.3.1"])
    s.add_dependency(%q<cucumber>.freeze, [">= 10.0"])
  end
end
